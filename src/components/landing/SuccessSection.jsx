...
const SuccessSection = () => {
  return (
    <section className="bg-[hsl(160,49%,92%)] py-20 px-4 mt-4">
   ...
   <p className="text-gray-700 text-xl  mb-10 px-2 text-center">
  ...
  you write confidently and finish strong.
        ...
        <div className="flex flex-row justify-center items-center gap-5 ">
          <button className="bg-[#00A86B] hover:bg-green-700 text-white cursor-pointer font-medium py-2 px-3  rounded-xl shadow-2xl transition-colors duration-200 ">
            Start Thesis
          </button>
          <button className="border-3 border-green-600 text-green-600 hover:bg-green-50 cursor-pointer font-medium rounded-xl py-2 px-3  shadow-2xl transition-colors duration-200">
            Write Paper
          </button>
        </div>
