...
const OurServices = () => {
  ...
  return (
    <section className="bg-white">
      {/* Centered Our Services Intro */}
      <div
        className={`h-[60vh] flex flex-col items-center justify-center text-center px-6 transition-all duration-400 mb-8 ${
          scrolled
        ...
        <div className="space-y-8">
          {services.map((service, index) => (
            <div
              ...
              className="block bg-gray-50 border border-gray-200 rounded-2xl shadow p-6 hover:shadow-md transition cursor-pointer"
            >
              ...
              <span className="text-orange-600 font-semibold hover:underline text-sm">
                Learn More →
              </span>
            </div>
          ))}
